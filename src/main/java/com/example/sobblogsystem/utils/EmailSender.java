 ...
 * @Author: immorts
 * @Description: TODO
 * @Date: Created in 12:46 AM 2022/5/18 2022
 * @Modified By:
 */
@Slf4j
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_QQ(false), "3197166390@qq.com", "kmbdqthhykpjdgdj");
    }
    ...
    public static void sendRegisterVerifyCode(String code,String address) throws Exception{
        EmailSender.subject("阳光沙滩博客系统注册验证码")
                .from("阳光沙滩博客系统")
                .text("您的验证码是: " + code + "有效期为十分钟，若非本人操作，请忽略此邮件。")
